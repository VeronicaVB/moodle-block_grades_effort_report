...
$functions = [
    'block_grades_effort_report_get_context' => [
        'classname' => 'block_grades_effort_report\external\api', // Class containing a reference to the external function.
        'methodname' => 'get_context', // External function name.
        'description' => 'Get template context', // Human readable description of the WS function.
