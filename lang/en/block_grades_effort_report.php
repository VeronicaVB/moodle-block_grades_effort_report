...
$string['pluginname'] = 'Grades and Effort Report';
$string['pluginname_desc'] = 'This plugin depends on DW.';
$string['grades_effort_report'] = 'Grades and Effort Report';
$string['grades_effort_report:addinstance'] = 'Add a new grades and effort block';
$string['grades_effort_report:myaddinstance'] = 'Add a new grades and effort block to the My Moodle page';
